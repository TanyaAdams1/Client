...
QT_MOC_LITERAL(5, 37, 21) // "on_pushButton_clicked"
    ...
    "login\0Login\0\0QPair<QString,int>\0pair\0"
...
void login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Login((*reinterpret_cast< const QPair<QString,int>(*)>(_a[1]))); break;
        ...
        {
            typedef void (login::*_t)(const QPair<QString,int> );
...
// SIGNAL 0
void login::Login(const QPair<QString,int> _t1)
{
