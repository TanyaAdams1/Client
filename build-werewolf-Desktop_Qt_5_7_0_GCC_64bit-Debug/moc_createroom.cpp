...
QT_MOC_LITERAL(1, 11, 7), // "newroom"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 18), // "QPair<QString,int>"
QT_MOC_LITERAL(4, 39, 4), // "pair"
QT_MOC_LITERAL(5, 44, 21) // "on_pushButton_clicked"

    },
    "createroom\0newroom\0\0QPair<QString,int>\0"
    "pair\0on_pushButton_clicked"
};
...
void createroom::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (createroom::*_t)(const QPair<QString,int> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&createroom::newroom)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject createroom::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_createroom.data,
      qt_meta_data_createroom,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *createroom::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_createroom.stringdata0))
        return static_cast<void*>(const_cast< createroom*>(this));
...
// SIGNAL 0
void createroom::newroom(const QPair<QString,int> _t1)
{
